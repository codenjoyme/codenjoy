...
<ol>
    <li>Download server templates from this location <a href="${pageContext.request.contextPath}/resources/user/tetris-servers.zip">tetris-servers.zip</a></li>
    <li>Setup project according to instruction in README.txt for your developing language</li>
    <li>Read game instructions <a href="http://codenjoy.com/portal/?p=170">http://codenjoy.com</a> (if no Internet, please <a href="${pageContext.request.contextPath}/resources/help/help.html">click here</a>) </li>
