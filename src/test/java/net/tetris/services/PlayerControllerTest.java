...
//    private Joystick joystick;
    ...
    public void setUp() throws Exception {
        ...
        controller.init();
        vasya = new Player("vasya", "http://localhost:1111/", new PlayerScores(emptyLevels(), 0), emptyLevels());
    }
    ...
    public void shouldSendRequestControlCommandsNoTailSlash() throws IOException, InterruptedException {
        try {
            controller.requestControl(new Player("vasya", "http://localhost:1111", new PlayerScores(emptyLevels(), 0), emptyLevels()),
