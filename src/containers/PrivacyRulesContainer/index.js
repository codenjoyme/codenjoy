        ...
        <div className='content'>
            ...
            <ol>
                <li>
                    ...
                    <ol>
                        <li>1.1. вік - не молодше 18 років;</li>
                        <li>
                            1.2. володіє чи має змогу користуватися комп'ютером
                            чи ноутбуком з доступом до мережі Інтернет. Учасник
                            оплачує доступ в мережу Інтернет самостійно;
                        </li>
                        <li>
                            1.3. зареєструється на Сайті Конкурсу шляхом
                            заповнення анкети;
                        </li>
                        <li>
                            1.4. ознайомлена з Правилами конкурсу і Політикою
                        ...
                        <li>
                            1.5. має реєстраційний номер облікової картки
