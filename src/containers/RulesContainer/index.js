            ...
            <div className='container'>
                ...
                <div className='content'>
                    ...
                    <p>
                        ...
                        таблеку люті, таблетку польоту, яблуко або іншу Змійку.
                        Якщо Змійка натрапить на камінь - вона зменшується на 4
                        одиниці. Якщо Змійка менше двох клітин - вона загине. За
                        золото, яблука, у разі смерті інших Змійок, Ваша Змійка
                        отримає бонусні бали. За свою смерть і за камені -
                        штрафні бали. Бали підсумовуються.
                    </p>
                    ...
                    <p>
                        ...
                        піклується тільки про логіку переміщень вашого Бота. Всі
                        необхідні допоміжні речі вже зроблені за Вас.
                    </p>
                    <p>
                    ...
                    <p>
                        Далі необхідно подключиться з коду до сервера через
                    ...
                    <p>
                        ...
                        осмислену гру і перемогти, набравши найбільшу кілкість
                        балів.
                    </p>
                    ...
                    <p>
                        ...
                        таблетки люті, діють звичайні правила зіткнень.
                        <br />
                    </p>
                    <div className={ classnames('subTitle', mb30) }>
                        Підказки:
                    ...
                    <p>
                        Для реалізації свого алгоритму можна використовувати вже
                        готовий клас DeikstraFindWay і (зокрема) метод
                        getShortestWay ().
                        <br />
                        ...
                        <ul>
                            <li>
                                - Переміщення у випадкову сторону, якщо
                                відповідна клітина вільна.
                            </li>
                            <li>
                                - Рух на вільну клітину в бік найближчого
                                яблука.
                            </li>
                            <li>
                            ...
                            <li>
                                - Ухилення від довших суперників і від
                                суперників у стані люті.
                            </li>
                            <li>
                    ...
                    <p>
                        <ol>
                            ...
                            <li>
                                2. Кожна Кімната грає декалька Раудів. Один
                                Раунд триватиме доти, доки не залишиться тільки
                                одна Змійка на Полі.
                            </li>
                            <li>
                                3. Після серії із кількох Раудів у одній
                                Кімнаті, Кімнату Участникові буде змінено
                                автоматично на іншу на Кімнату із іншим складом
                                Участників.
                            </li>
                            <li>
                                4. Вигляд Поля може бути змінено від Матчу до
                                Матчу.
                            </li>
                            <li>
                                5. За один Iгровий День з 9:00 до 19:00 кожен
                                Участник матиме можливість заробити певну
                                кількість Балів, які сумуються впродовж всіх
                                Матчів/Раудів за цей проміжок часу.
                            </li>
                            <li>
                                6. Переможцями Ігрового Дня вважаються 10 Ботів
                                Участників за результатами всіх Раундів Ігрового
                            ...
                            <li>
                                8. Якщо на останнє місце (10-те) будуть
                                претендувати більше ніж один Участник (отримано
                                однакову кількість Балів) - всі вони обираються
                                Переможцями цього Iгрового Дня.
                            </li>
                            <li>
                                9. Переможці кожного дня автоматично попадають
                                до Фіналу, який відбудеться останнього дня
                                Конкурсу (14.02.2019).
                            </li>
                            <li>
                                10. Участники, що не потрапили до списку
                                Переможців у будь-який день Конкурсу до Фіналу,
                                мають можливість вдосконалити свого Бота і
                                спробувати потрапити до списку Фіналістів у
                                будь-який інший Ігровий День до Фіналу, тобто до
                                13.02.2019 включно.
                            </li>
                            <li>
                                11. Фінал Конкурсу проходитиме подібно до
                                Ігрового Дня із такими відмінностями:
                            </li>
                            <li>
                                11.1 Перша частина Фіналу триватиме 14.02.2019 з
                                9:00 до 17:00, після чого буде обрано 10 кращих
                                Ботів Участників за результатами всіх Раундів
                                цієї частини Фіналу - Суперфіналісти.
                            </li>
                            <li>
                                11.2 Суперфінал триватиме 14.02.2019 з 18:00 до
                                19:00 у формі серії Раундів серед
                                Суперфіналістів.
                            </li>
                        </ol>
                    </p>
                    ...
                    <p>
                        ...
                        створено Канал у додатку Telegram, приєднатися до якого
                        можна за &nbsp;
