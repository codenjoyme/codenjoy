...
function initRunnerBefunge(console) {
    ...
    var commands = [
...

        {
            ...
            minLevel: 1,
            img1: '../sprite/expansion/ekids/floor.png'
        },

        {
            ...
            minLevel: 11,
            img1: '../sprite/expansion/ekids/start.png'
        },

        {
            ...
            minLevel: 11,
            img1: '../sprite/expansion/ekids/exit.png'
        },

        {
            ...
            minLevel: 11,
            img1: '../sprite/expansion/ekids/gold.png'
        },

        {
            ...
            minLevel: 11,
            img1: '../sprite/expansion/ekids/box.png'
        },

        {
            ...
            minLevel: 11,
            img1: '../sprite/expansion/ekids/hole.png'
        }
    ];
                ...
                elem =
                    '<div class="img-tooltip">' +
                        '<div class="img-container">' +
                            '<img src = "../../resources/expansion/' + commands[index].img1 + '">' +
                            '<img src = "../../resources/expansion/' + commands[index].img2 + '">' +
                        '</div>' +
                        '<div class="img-container">' +
                            '<img src = "../../resources/expansion/' + commands[index].img3 + '">' +
                            '<img src = "../../resources/expansion/' + commands[index].img4 + '">' +
                        '</div>' +
    ...
    var buildBoll = function() {
        var ball = '<div id="ball" class="ball hidden"><img src = "../../resources/expansion/img/sprite/ball.png"></div>';
