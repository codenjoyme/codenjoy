...
namespace ExpansionBot
{
    class Program
    {
        ...
        {
            Thread.Sleep(500);
            //Connect("ws://ecsc0010498a:8080/codenjoy-contest/ws?user=nzeemin@gmail.com").Wait();
            Connect("ws://127.0.0.1:8080/codenjoy-contest/ws?user=user@email.com").Wait();
            //Connect("ws://ecsc00104eef.epam.com:8080/codenjoy-contest/ws?user=nikita_zimin@epam.com").Wait();
