...
public class SingleTest {
    ...
    public void setup() {
        ...
        game1 = new Single(sokoban, new Player(listener1), factory);

        listener2 = mock(EventListener.class);
        game2 = new Single(sokoban, new Player(listener2), factory);

        listener3 = mock(EventListener.class);
        game3 = new Single(sokoban, new Player(listener3), factory);
