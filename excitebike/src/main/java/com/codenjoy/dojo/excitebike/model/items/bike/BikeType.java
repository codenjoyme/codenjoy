...
public enum BikeType implements CharElements {
    ...
    BIKE_FALLEN_AT_SPRINGBOARD_LEFT_UP('F'),
    BIKE_FALLEN_BEHIND_SPRINGBOARD_LEFT_UP('G'),
    BIKE_FALLEN_AT_SPRINGBOARD_DARK('H'),
    BIKE_FALLEN_AT_SPRINGBOARD_LEFT_DOWN('J'),
    BIKE_FALLEN_AT_SPRINGBOARD_RIGHT_UP('Y'),
    BIKE_FALLEN_BEHIND_SPRINGBOARD_RIGHT_UP('R'),
    BIKE_FALLEN_AT_SPRINGBOARD_LIGHT('M'),
    BIKE_FALLEN_AT_SPRINGBOARD_RIGHT_DOWN('N'),
    ...
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_LEFT_UP('f'),
    OTHER_BIKE_FALLEN_BEHIND_SPRINGBOARD_LEFT_UP('g'),
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_DARK('h'),
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_LEFT_DOWN('j'),
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_RIGHT_UP('y'),
    OTHER_BIKE_FALLEN_BEHIND_SPRINGBOARD_RIGHT_UP('r'),
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_LIGHT('m'),
    OTHER_BIKE_FALLEN_AT_SPRINGBOARD_RIGHT_DOWN('n'),
