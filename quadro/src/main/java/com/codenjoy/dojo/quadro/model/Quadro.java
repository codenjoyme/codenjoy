...
import com.codenjoy.dojo.quadro.model.items.Bomb;
        ...
        return new BoardReader() {
            ...
            public Iterable<? extends Point> elements() {
                return new LinkedList<Point>(){{
                    addAll(Quadro.this.getWalls());
                    addAll(Quadro.this.getHeroes());
                    addAll(Quadro.this.getGold());
                    addAll(Quadro.this.getBombs());
                }};
            }
        };
    }
