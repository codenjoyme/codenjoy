...
public class SingleTest {
    ...
    public void setup() {
        ...
        Quadro quadro = new Quadro(level, dice);
        PrinterFactory factory = new PrinterFactoryImpl();

        listener1 = mock(EventListener.class);
        game1 = new Single(quadro, new Player(listener1), factory);

        listener2 = mock(EventListener.class);
        game2 = new Single(quadro, new Player(listener2), factory);

        listener3 = mock(EventListener.class);
        game3 = new Single(quadro, new Player(listener3), factory);
