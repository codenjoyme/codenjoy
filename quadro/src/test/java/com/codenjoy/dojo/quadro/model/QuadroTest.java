...
public class QuadroTest {
    ...
    //TODO я могу походить только заполнив один из нижних рядов
    //TODO соперник может положить фишку в ряд, который я изначально положил,либо в оставшиеся из 7 вертикальных рядов
