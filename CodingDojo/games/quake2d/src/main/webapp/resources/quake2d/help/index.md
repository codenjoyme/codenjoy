...
<h1 class="entry-title">Quake2D codenjoy — как играть?</h1>
</header>
...
<p>Итак, игрок <a href="/codenjoy-contest/register?gameName=quake2d">
регистрируется на сервере</a>, указывая свой email</p>

<p>Далее необходимо подключиться <a href="../../../resources/quake2d/user/clients.zip">из кода</a>
