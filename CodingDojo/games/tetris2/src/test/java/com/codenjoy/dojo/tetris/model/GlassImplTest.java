...
//        glass.setEventListener(listener);
...
//
//        verify(listener).linesRemoved(removedLines.capture());
...
//        glass.drop(point, 0, HEIGHT);
//
//        verify(listener).figureDropped(droppedFigure.capture());
...
//        glass.empty();
//
//        verify(listener).glassOverflown();
//    }
//
//    @Test
//    public void shouldTriggerAllListenersWhenOverflow() {
//        TetrisGlass glass = new TetrisGlass(WIDTH, HEIGHT, listener, listener);
//
//        glass.empty();
//
//        verify(listener, times(2)).glassOverflown();
//    }
//
//    @Test
...
//        glass.drop(point, 0, HEIGHT);
//
//        verify(listener, times(2)).figureDropped(droppedFigure.capture());
//    }
//
//    @Test
...
//            verify(listener, times(1)).figureDropped(Matchers.<Figure>any());
//        } catch (Exception e) {
...
//
//        assertEquals(Elements.RED, glass.getDroppedPlots().get(0).getColor());
//    }
//
//    @Test
