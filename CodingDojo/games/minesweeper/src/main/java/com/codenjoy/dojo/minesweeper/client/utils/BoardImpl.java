package com.codenjoy.dojo.minesweeper.client.utils;

import com.codenjoy.dojo.minesweeper.client.Element;

import java.util.LinkedList;
import java.util.List;

import static com.codenjoy.dojo.minesweeper.client.utils.Point.*;
