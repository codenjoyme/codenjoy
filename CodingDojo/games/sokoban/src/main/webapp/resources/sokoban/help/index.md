...
Герою предстоит заталкивать ящики на платформы - делает он это путем передвижения 
в сторону ящика, и если за ящиком есть свободное место - ящик передвинется.
Будь осторожен - если придвинуть ящик к стенке есть шанс, что его оттуда 
не получится достать. 

За каждый ящик на своем месте герой получает бонусные очки[*](index.md#ask). 
Если герой заблокировал ящики - штрафные очки[*](index.md#ask). 
...
* `UP`, `DOWN`, `LEFT`, `RIGHT` – перемещение героя (самого или вместе с ящиком)
  в заданном направлении, если его (их) передвижению ничего не препятствует.   
...
* Попробовать добраться до ближайшего ящика.
* Попробовать передвинуть ящик в любое место.
* Попробовать передвинуть ящик на платформу.
