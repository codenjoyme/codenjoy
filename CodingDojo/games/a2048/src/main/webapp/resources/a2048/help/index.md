...
хода в свободных угловых ячейках появится[(?)](#ask) цифра 2.
...
На поле могут[(?)](#ask) встретиться препятствия, останавливающие движения цифер. 
...
[(?)](#ask)Точные настройки на данный момент игры уточни у Сенсея.
