...
public class DirectionTest {
    ...
    public void test_valueOfName() {
        assertEquals(0, Direction.valueOf("LEFT").getValue());
        assertEquals(1, Direction.valueOf("RIGHT").getValue());
        assertEquals(2, Direction.valueOf("UP").getValue());
        assertEquals(3, Direction.valueOf("DOWN").getValue());
    }
