...
public class SingleTest {
    ...
    public void shouldDrawLaserDeath() {
        ...
        assertE(single1,
                ...
                "-----" +
                "-----");
        assertEquals(1, hero1().getGoldCount());
        ...
        assertE(single1,
                ...
                "-----" +
                "-----");
        assertEquals(2, hero1().getGoldCount());
    ...
    @Test
    public void threeTemporaryGoldsDrop_AfterHeroDeath() {
        givenFl("╔════┐" +
                "║.S..│" +
                "║....│" +
                "║..E.│" +
