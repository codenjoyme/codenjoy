...
class BoardScalaTest {
  @Test def test() {
    ...
    assertEquals("[[2,4], [3,2], [3,3], [3,4]]", board.getGlass.get(Elements.ORANGE).toString)

    assertEquals("[[0,1], [1,1], [1,2], [2,2], [2,4], [3,2], [3,3], [3,4]]", board.getGlass.get(Elements.GREEN, Elements.ORANGE).toString)
