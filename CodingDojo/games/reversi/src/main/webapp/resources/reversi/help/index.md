...
<p>Итак, игрок <a href="/codenjoy-contest/register?gameName=reversi">
регистрируется на сервере</a>, указывая свой email</p>

<p>Далее необходимо подключиться <a href="../../../resources/reversi/user/clients.zip">из кода</a>
...
<p>Более детальнее читай правила <a href="https://ru.wikipedia.org/wiki/%D0%A0%D0%B5%D0%B2%D0%B5%D1%80%D1%81%D0%B8">на Википедии</a></p>
