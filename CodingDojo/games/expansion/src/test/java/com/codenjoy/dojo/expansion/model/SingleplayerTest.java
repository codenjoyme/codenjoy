...
public class SingleplayerTest extends AbstractSingleplayerTest {
    ...
    public void shouldCreateSixPlayersInTwoDifferentRooms() {
        ...
        assertL(level1, AbstractMultiplayerTest.PLAYER3);
        assertE(forces1, AbstractMultiplayerTest.PLAYER3);
        assertL(level1, AbstractMultiplayerTest.PLAYER4);
        assertE(forces1, AbstractMultiplayerTest.PLAYER4);
        ...
        String forces2 =
                ...
                "------\n" +
                "------\n";
        assertL(level2, AbstractMultiplayerTest.PLAYER5);
        assertE(forces2, AbstractMultiplayerTest.PLAYER5);
