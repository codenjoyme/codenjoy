...
public class SingleTest {
    ...
    public void setup() {
        ...
        SnakeBoard SnakeBoard = new SnakeBoard(level, dice);
        PrinterFactory factory = new PrinterFactoryImpl();

        listener1 = mock(EventListener.class);
        game1 = new Single(SnakeBoard, listener1, factory);

        listener2 = mock(EventListener.class);
        game2 = new Single(SnakeBoard, listener2, factory);

        listener3 = mock(EventListener.class);
        game3 = new Single(SnakeBoard, listener3, factory);
