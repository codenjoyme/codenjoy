...
по очкам. Каждый играет на своем поле. Герой может прыгать из состояния спокойствия
...
можно выше и с каждым тиком ты заработаешь больше очков. 

Ты проигрываешь в двух случаях:
...
* Распознай момент, когда нужно подпрыгнуть и сделай это.
* Изучи другие варианты прыжков.
* Обходи препятствия на платформах.
* Собирай призы.
