...
{
    public abstract class CliffordBase
    {
        private const string ResponsePrefix = "board=";

        protected CliffordBase(string serverUrl)
        {
            ServerUrl = serverUrl;
        }
        ...
        protected static string CliffordActionToString(CliffordAction action)
        {
            switch (action)
            {
                case CliffordAction.GoLeft: return "left";
                case CliffordAction.GoRight: return "right";
                case CliffordAction.GoUp: return "up";
                case CliffordAction.GoDown: return "down";
                case CliffordAction.CrackLeft: return "act,left";
                case CliffordAction.CrackRight: return "act,right";
                default: return "stop";
            }
        }
    }
