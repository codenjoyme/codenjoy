...
import com.codenjoy.dojo.puzzlebox.model.Player;
import com.codenjoy.dojo.puzzlebox.model.PuzzleBox;
...
public class GameRunner extends AbstractGameType<GameSettings> {
    ...
    public static final String GAME_NAME = "puzzlebox";
    ...
    public GameField createGame(int levelNumber, GameSettings settings) {
        return new PuzzleBox(settings.level(), getDice(), settings);
    }
