...
На поле располагаются две вертикальные панели, играет либо
...
После забивания гола мяч появляется в центре поля
и начинает движение имея произвольное направление.
...
* `UP`, `DOWN` – приводят к движению панели
...
* Стараться держать платформу на том же уровне, что и летящий мяч.
* Попробовать закрутить мяч.
