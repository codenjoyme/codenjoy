...
call explorer http://127.0.0.1:%PORT%%CONTEXT%

%JAVA_HOME%\bin\java -jar %APP_HOME%\server.war --spring.profiles.active=%SPRING_PROFILES% --context=%CONTEXT% --server.port=%PORT%
