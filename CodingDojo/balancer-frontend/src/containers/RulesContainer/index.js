        ...
        return (
            <div className='container'>
                ...
                <div className='content'>
                    ...
                    <ul>
                        <li>
                            UNSTOPPABLE_LASER - описание   // !!!!!!TODO!!!!!!!
                        </li>
                        <li>
                            DEATH_RAY - описание // !!!!!!TODO!!!!!!!
                        </li>

                        <li>
                            Перки випадають на місці вбитого зомбі з
                            певною{ this._gets('perkDropRatio') } верогідністю у %.
                        </li>
                        <li>
                            Дія перку зникає через деякий час:
                            <ul>
                                <li>
                                    UNSTOPPABLE_LASER певна кількість{ this._gets('perkAvailability') } тіків (секунд).
                                </li>
                            </ul>
                        </li>
                        <li>
                            Якщо перк ніхто не підібрав, він зникає з поля
                            після через деякий{ this._gets('perkActivity') } час.
                        </li>
                    </ul>
                    ...
                    <p id="settings">
                        ...
                        <ul>
                            ...
                            <li>???PerkAvailability???: { this._gets('perkAvailability') }.</li>
