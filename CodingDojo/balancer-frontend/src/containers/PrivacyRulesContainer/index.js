    ...
    <div className='container'>
        <div className='content'>
            ...
            <ol>
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            підпункті 3 пункту 1 розділу 2 цих Правил);
                        </li>
                        <li>
                ...
                <li>
                    4.  Організатор має право (але не зобов’язаний) перевіряти
                    та видаляти заявки на участь, що не відповідають підпунктам
                    1-4 пункту 1 розділу 2 Правил Конкурсу. Організатор залишає
                ...
                <li>
                    5.  Погоджуючись з Політикою конфіденційності та Згода на
            ...
            <ol>
                <li>
                    ...
                    Кожен Ігровий день розпочинається о 9:00 і закінчується о
                    19:00 (тут і далі – Ігровий день). Будь-яка участь у
                ...
                <li>
                    10. За один Ігровий День кожен Учасник матиме можливість
                ...
                <li>
                    19. Сервери Конкурсу працюватимуть з понеділка по п’ятницю в
                    час з 9:00 до 19:00.
                </li>
                <li>
                    20. Список переможців кожного ігрового дня буде доступний
                ...
                <li>
                    23. Фінал Конкурсу проходитиме подібно до Ігрового Дня із
                    такими відмінностями:
                    <ol>
                        <li>
                            23.1 Фінал Конкурсу проходитиме останнього дня
                            Конкурсу { endDate }
                        </li>
                        <li>
                            23.2 У Фіналі братимуть участь тільки Переможці
                            кожного Ігрового Дня Конкурсу у період з { startDate }
                            по { registerEndDate }.
                        </li>
                        <li>23.3 Фінал триватиме { endDate } з 9:00 до 19:00.</li>
                        <li>
                            23.4 Трьох переможців Суперфіналу буде визначено за
                            кількістю зароблених балів.
                        </li>
                    </ol>
                </li>
                <li>
                    24. Учасники, які посядуть перше, друге та третє місця в
                ...
                <li>
                    26. Призи є матеріальними: ігрова консоль PlayStation 4 Pro
                ...
                <li>
                    29. Приз надсилається/вручається Переможцю Конкурсу, який
                    виконав усі умови цих Правил.
                </li>
                <li>
                    30. Вручення Призу допускається лише особі, яка отримала на
                    нього право згідно з умовами цих Правил, і виключно в
                    порядку, встановленому цими Правилами. 
                </li>
                <li>
                    31. Організатор має право відмовити у видачі Призу Переможцю
                ...
                <li>
                    32. Організатор не несе відповідальність за будь-які
