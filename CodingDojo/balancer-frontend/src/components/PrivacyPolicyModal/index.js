                        ...
                        <div className='content'>
                            ...
                            <ol>
                                <li>
                                    ...
                                    інформовану і свідому згоду ТОВ «ЕПАМ
                                    СИСТЕМЗ» (юридична та поштова адреса:
                                    Україна, г. Київ, вул. Фізкультури 28,
                                    03150) (далі – «Компанія») на обробку моїх
                                ...
                                <li>
                                    ...
                                    групи компаній ЕПАМ (в тому числі
                                    ...
                                    Manager, Google reCAPTCHA, .NET фреймворку,
                                    IS3 компонента, провайдерів авторизації
                                ...
                                <li>
                                    ...
                                    правилами конкурсу «EPAM BOT CHALLENGE»
                                ...
                                <li>
                                    ...
                                    ЕПАМ (в тому числі іноземним суб'єктам
                                ...
                                <li>
                                    ...
                                    групи компаній ЕПАМ з метою розгляду питання
                                ...
                                <li>
                                    ...
                                    ЕПАМ, а Сайт використовується всіма
                                ...
                                <li>
                                    ...
                                    даних): Україна, г. Київ, вул. Фізкультури
                                    28, 03150.{ ' ' }
                                </li>
                                ...
                                <li>
                                    ...
                                    даних Відвідувачів Сайту (активне посилання
                                    на Політику), та Правилами конкурсу (активне
                                    посилання на Правила конкурсу),
                                </li>
                                <li>
                                ...
                                <li>
                                    - інформацією про джерела збирання,
                                    місцезнаходження своїх персональних даних,
