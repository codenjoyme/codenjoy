...
public class UserDetailsServiceTests {
    ...
    public void init() {
        ...
        this.response = UserDetailsResponse.newBuilder().setId(USER_ID).setEmail(EMAIL).setSlackEmail(EMAIL).build();
    ...
    public void getUserDetailsTest() {
        ...
        when(registration.getSlackEmailById(USER_ID)).thenReturn(EMAIL);
