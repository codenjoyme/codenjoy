...
public enum Elements {
    ...
    CONSTRUCTION_DESTROYED_UP_LEFT_DOWN('╒'),
    CONSTRUCTION_DESTROYED_UP_LEFT_RIGHT('╓'),

    CONSTRUCTION_DESTROYED_UP_RIGHT('╗'),
    CONSTRUCTION_DESTROYED_UP_RIGHT_LEFT('╖'),
    CONSTRUCTION_DESTROYED_UP_RIGHT_DOWN('╕'),

    CONSTRUCTION_DESTROYED_DOWN_LEFT('╚'),
    CONSTRUCTION_DESTROYED_DOWN_LEFT_UP('╘'),
    CONSTRUCTION_DESTROYED_DOWN_LEFT_RIGHT('╙'),

    CONSTRUCTION_DESTROYED_DOWN_RIGHT('╝'),
    CONSTRUCTION_DESTROYED_DOWN_RIGHT_UP('╛'),
    CONSTRUCTION_DESTROYED_DOWN_RIGHT_LEFT('╜'),
