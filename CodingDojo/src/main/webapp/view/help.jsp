    ...
    <script>
        $(document).ready(function () {
            $("#games").change(function () {
                var val = $("#games").val();
                if (val == '') return;
                window.location.href = "${pageContext.request.contextPath}/resources/user/" + val + "-servers.zip";
            });
        });
    </script>
</head>
...
<ol>
    ...
    <li>Read game instructions: <c:forEach items="${gameNames}" var="gameName"><a href="${pageContext.request.contextPath}/resources/help/${gameName}.html">${gameName}</a>&nbsp;&nbsp;</c:forEach></li>
