...
public class LockedTest {
    ...
    public void setup() {
        ...
        when(gameType.newGame(any(EventListener.class))).thenReturn(game);
    ...
    public void testRealObject() {
        final Game game = gameType.newGame(null);
    ...
    public void testLockedObject() {
        final Game game = new LockedGameType(gameType).newGame(null);
