 ...
 * Time: 5:22
 */
public class SingleChessTest {

    private EventListener listener1;
    private EventListener listener2;
    private EventListener listener3;
    private SingleChess game1;
    private SingleChess game2;
    private SingleChess game3;
    private Dice dice;
    ...
    public void setup() {
        ...
        Chess Chess = new Chess(level, dice);

        listener1 = mock(EventListener.class);
        game1 = new SingleChess(Chess, listener1);

        listener2 = mock(EventListener.class);
        game2 = new SingleChess(Chess, listener2);

        listener3 = mock(EventListener.class);
        game3 = new SingleChess(Chess, listener3);
    ...
    public void shouldGetGold() {
        ...
        verify(listener3).event(ChessEvents.WIN);
