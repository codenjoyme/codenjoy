...
public class SingleTest {
    ...
    public void setup() {
        ...
        Reversi reversi = new Reversi(level, dice);
        PrinterFactory factory = new PrinterFactoryImpl();

        listener1 = mock(EventListener.class);
        game1 = new Single(reversi, new Player(listener1), factory);

        listener2 = mock(EventListener.class);
        game2 = new Single(reversi, new Player(listener2), factory);

        listener3 = mock(EventListener.class);
        game3 = new Single(reversi, new Player(listener3), factory);
